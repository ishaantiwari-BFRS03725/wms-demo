...
const css = `
.rx-screen{--c-bg:#ffffff;--c-bg2:#f5f3ee;--c-border:#e2dfd5;--c-border2:#d0ccbf;--c-t1:#1a1a1a;--c-t2:#555555;--c-t3:#8a8a85;--c-info-t:#2d5aa8;--c-info-b:#bcd0f5;--c-info-bg:#e6eef9;--c-mono:'JetBrains Mono',ui-monospace,SFMono-Regular,Menlo,monospace;
...
.rx-node.active{background:var(--c-info-bg);color:var(--c-info-t);font-weight:600;box-shadow:inset 2px 0 0 #2d5aa8}
...
.rx-req{color:#b5321f}
.rx-select,.rx-input{display:flex;align-items:center;justify-content:space-between;gap:8px;font-size:13px;color:var(--c-t1);padding:11px 13px;border:1px solid var(--c-border2);border-radius:4px;background:var(--c-bg)}
...
.rx-quick-chip{font-size:12px;color:var(--c-t1);padding:9px 12px;border:1px solid var(--c-border);border-radius:4px;background:var(--c-bg2);margin-bottom:8px}
...
.rx-analytics-badge{width:84px;height:84px;flex:none;border-radius:4px;background:var(--c-info-bg);color:#9ab0d4;display:flex;align-items:center;justify-content:center}
